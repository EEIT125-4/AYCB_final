	...
	<%@include file="../jspf/memberPanel.jspf"%>
		<div class="rightoutbox">
			<form action="${pageContext.request.contextPath}/member/updateComplete" method="post" enctype='multipart/form-data' >
				...
				<div class="form-inline " style="margin-left:280px;margin-bottom: 10px;">
				...
				<label for="file" style="font-weight: bold; font-size: 20px;margin-left:0px;margin-bottom:20px"></label>
...
<div class="form-inline" style="margin-left:95px">
<textarea id="introduce" name="introduce"  cols="70"  style="magin-left:100px"><jsp:getProperty name="member" property="introduce" /></textarea>

									</div>
									
<br>

			<button name="update" type="submit" class="btn btn-dark" style="width:180px;margin-left:295px" >更新</button>
