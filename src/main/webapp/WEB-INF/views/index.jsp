...
<!-- 			<div class='sellhottext'> -->
<!-- 				<img class='textimg' src='image/sellhotpro.gif'> -->
<!-- 			</div> -->
<!-- 			<div class="topbox"> -->
<!-- 				<div class="toprank">1</div> -->
<!-- 				<div> -->
<!-- 					<img src="image/top5bar1.png"> -->
<!-- 				</div> -->
<!-- 				<div class="topimgbox"> -->
<%-- 					<a href='<c:url value="/Detail" />?no=&cate='> --%>
<%-- 					<img class="topimg" src='${pageContext.request.contextPath}/pic/39'></a> --%>
<!-- 				</div> -->
<!-- 				<div class="topinfo"> -->
<!-- 					<div class="brandinfo">Dr.Morita </div> -->
<!-- 					<div class="proinfo">DR.JOU六重玻尿酸極水潤精華乳150ml</div> -->
<!-- 					<div class="seriesinfo">Dr.Jou 六重玻尿酸系列</div> -->
<!-- 					<div class="cateinfo">防曬隔離</div> -->
<!-- 					<div class="dealbox"> -->
<!-- 						<div class="priceinfo">NT$ 2000</div> -->
<!-- 						<div class="btninfo"><img class="btnimg" src='image/bg_cart_b.svg'>加入購物車</div> -->
<!-- 					</div> -->
<!-- 				</div> -->
<!-- 			</div> -->
<!-- 			<div class="topbox"> -->
<!-- 				<div class="toprank">2</div> -->
<!-- 				<div> -->
<!-- 					<img src="image/top5bar1.png"> -->
<!-- 				</div> -->
<!-- 				<div class="topimgbox"> -->
...
<!-- 			</div> -->
<!-- 			<div class="botbox"> -->
<!-- 				<div class="botrank">3</div> -->
<!-- 				<div> -->
<!-- 					<img class="botrankimg" src="image/top5bar2.png"> -->
<!-- 				</div> -->
<!-- 				<div class="botimgbox"> -->
<%-- 					<a href='<c:url value="/Detail" />?no=&cate='> --%>
<%-- 					<img class="botimg" src='${pageContext.request.contextPath}/pic/39'></a> --%>
<!-- 				</div> -->
<!-- 				<div class="botinfo1"> -->
<!-- 					<div class="botbrandinfo">Dr.Morita </div> -->
<!-- 					<div class="botseriesinfo">Dr.Jou 六重玻尿酸系列</div> -->
<!-- 					<div class="botcateinfo">防曬隔離</div> -->
<!-- 				</div> -->
<!-- 				<div class="botinfo2"> -->
<!-- 					<div class="botproinfo">DR.JOU六重玻尿酸極水潤精華乳150ml</div> -->
...
<!-- 			</div> -->
<!-- 			<div class="botbox"> -->
<!-- 				<div class="botrank">4</div> -->
<!-- 				<div> -->
<!-- 					<img class="botrankimg" src="image/top5bar2.png"> -->
<!-- 				</div> -->
<!-- 			</div> -->
<!-- 			<div class="botbox"> -->
<!-- 				<div class="botrank">5</div> -->
<!-- 				<div> -->
<!-- 					<img class="botrankimg" src="image/top5bar2.png"> -->
<!-- 				</div> -->
<!-- 			</div> -->
