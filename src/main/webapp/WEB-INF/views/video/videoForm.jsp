	...
	<div class="col-lg-7">
		<form:form method="POST" modelAttribute="video" enctype='multipart/form-data'>			
			<div>				
				...
				<p style="width:400px; margin-right:20px">
					 <img id="imageDemo" class="demo"
						style="width: 400px; height: 300px;" src="${video.coverUrl}"
						onerror="javascript:this.src='${pageContext.request.contextPath}/image/noImage.jpg'">
						上傳圖片: <input id="imagefile" type="file" name="imagefile"
						accept="image/*">
				</p>				
				<p style="width:400px;" >
					<video style="width: 400px; height: 300px;" muted
						controls='controls' id="video_show">
						<source src="${video.url }" id="video_here">
					</video>
					上傳影片: <input id="videofile" name="videofile" type="file"
						accept="video/*">
				</p>
				</div>
				<div class="form-inline">
				<p class="form-inline" style="margin-right:173px">
					<label for="title" class="t1">影片標題:</label> <br>
					<form:input type="text" id="title" path="title"
						value="${video.title}" placeholder="影片標題" />

				</p>
				<p class="form-inline">
					<label for="category" class="t1">影片分類</label> <br>
				...
				<p>
					...
					<br>
					<form:textarea id="description" path="description" cols="100"
						rows="5" placeholder="向大家介紹你的影片"></form:textarea>

				</p>
				
              <div style="margin:0px 0px 30px 350px">
				<input type="submit" class="btn btn-secondary" name="confirmupdate"
					value="送出">
				<button type="button" class="btn btn-secondary"
					onclick="autoInput()">TEST</button>
			 </div>
			</div>
			<div>
