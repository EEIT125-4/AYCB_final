...
<section class="breadcrumb-blog set-bg"
	data-setbg="/AYCB/image/breadcrumb-bg.jpg"
	style="background-image: url(&quot;/AYCB/image/breadcrumb-bg.jpg&quot;);">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2>部落格文章上傳</h2>
	...
	<form:form method="POST" modelAttribute="blog" enctype='multipart/form-data'>
		<fieldset class="updateform">
			...
			<p>
				...
				<form:input type="text" name="picture" path="picture"
					value="${picture}" />
			</p>

			<label for="reflection">文章內文:</label>
			<form:textarea name="reflection" id="reflection" path="reflection"
				value="${reflection}" />
