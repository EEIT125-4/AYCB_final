...
<div class="contentoutbox">
	...
	<div class="back">
        ...
        <div class="format">
        	<input class="mbtn" type="button" value="會員" onclick='location.href="#"'>
            <input class="mbtn" type="button" value="商品" onclick='location.href="${pageContext.request.contextPath}/MProduct"'>
            <input class="mbtn" type="button" value="購物車" onclick='location.href="#"'>
        </div>
        <div class="format">
            <input class="mbtn" type="button" value="訊息" onclick='location.href="#"'>
            <input class="mbtn" type="button" value="活動" onclick='location.href="#"'>
            <input class="mbtn" type="button" value="留言板" onclick='location.href="#"'>
             </div>
